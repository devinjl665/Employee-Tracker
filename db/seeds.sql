...
VALUES (10, 'Salesperson', 60000, 1),
       ...
       (43, 'Customer Service Representative', 52000, 4),
       (54, 'Payment Processing Representative', 42800, 5),
       (65, 'Back End Developer', 81000, 3),
       (76, 'Pre-Customer Service Resprentative', 40000, 4);



INSERT INTO employees (id, last_name, first_name, position_id, manager_id)
